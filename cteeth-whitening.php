...
<head>
    ...
    <title>CTeeth Whitening / Bleaching</title>
...
<body class="pt-0"> 
    ...
    <!--Why Kalra Dental section Start -->
    <section class="py-4 py-lg-5">
        <div class="container py-xl-4">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-lg-7 ">
    ...
    <!-- An Investment section End -->

    <!-- Beyond Whitening Start -->
    <section class="py-2">
        <div class="container py-xl-4">
            <div class="row gx-4 gx-lg-5 align-items-center">
                <div class="col-lg-7 ">

    ...
    <nav class="py-2 d-none d-md-block" style="background-color:#181818">
        <div class="container">
            <div class="d-flex flex-wrap gap-2 align-items-center justify-content-center justify-content-sm-between">
                <a href="tel:+919829195898" class="d-inline-flex align-items-center gap-2 fs-15 fw-semibold text-white" aria-label="+91 98291 95898">
                <span>Have any questions?</span>
                    <span>+91 98291 95898</span>
                </a>
                <ul class="d-flex social__links gap-2 header__links gap-2">
                    <li>

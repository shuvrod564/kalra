        ...
        <div class="container">
            ...
            <div class="row g-4">
                <div class="col-lg-4 d-flex">
                    <div class="extra__card w-100">
                        <div class="caption__box py-3 px-4">
                            <h3 class="fs-5 text-41 fw-semibold">A Step-by-Step Guide</h3>
                            <p class="text-6a">
                ...
                <div class="col-lg-4 d-flex">
                    <div class="extra__card w-100">
                        <div class="caption__box py-3 px-4">
                            <h3 class="fs-5 text-41 fw-semibold">Recovery and Aftercare</h3>
                            <p class="text-6a">
                ...
                <div class="col-lg-4 d-flex">
                    <div class="extra__card w-100">
                        <div class="caption__box py-3 px-4">
                            <h3 class="fs-5 text-41 fw-semibold">Beyond the Treatment</h3>
                            <p class="text-6a">
            ...
            <div class="row g-4 gx-lg-5 align-items-center ">
                ...
                <div class="col-lg-7 ">
                    <div class="py-lg-4  text-center text-lg-start"> 
                        ...
                        <h2 class="fs-2 text-26 fw-bold mb-2 mt-4 mt-xxl-5">Your Journey to Dental Health Starts Here</h2>
                        <p class="mt-3">
